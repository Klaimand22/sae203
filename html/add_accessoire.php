...
<body>
    ...
    <main>
        <div class="container">
            ...
            <form method="POST" action="add_accessoire.php">
...
<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $requete = "INSERT INTO sae203_accessoire (marque, modele, description, reference, disponible, date_mise_en_service) VALUES ('$marque', '$modele', '$description', '$reference', '$disponible', '$date_mise_en_service')";
